...
public class WarriorAI : MonoBehaviour
{
    ...
    public void StartAI()
    {
        ...
        {
            controller.attacks.Add(new AttackDetails((Resources.Load("Attacks/Basic Slash") as GameObject).GetComponent<AttackDetailsInstance>()));
            controller.attacks.Add(new AttackDetails((Resources.Load("Attacks/Wide Slash") as GameObject).GetComponent<AttackDetailsInstance>()));
            controller.attacks.Add(new AttackDetails((Resources.Load("Attacks/Battlecry") as GameObject).GetComponent<AttackDetailsInstance>()));
        }
