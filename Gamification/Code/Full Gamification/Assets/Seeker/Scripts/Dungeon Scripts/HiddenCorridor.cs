...
// Essentially the same as the regular corridor class.

public class HiddenCorridor
{
    ...
    public void ReSetupCorridor(Room room, IntRange length, IntRange roomWidth, IntRange roomHeight, int columns, int rows, int rotation)
    {
        // Set a random direction (a random index from 0 to 3, cast to Direction).
        direction = (Direction)Random.Range(0, 4);
