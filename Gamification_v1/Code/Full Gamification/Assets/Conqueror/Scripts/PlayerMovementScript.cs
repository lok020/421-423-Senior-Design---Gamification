...
public class Player {
	...
	public Player() {
        ...
        int.TryParse(lines[5].Split(' ')[1], out g1);
        int.TryParse(lines[5].Split(' ')[2], out g2);
        int.TryParse(lines[5].Split(' ')[3], out g3);
        guns[0] = new Gun(g1 * damage, g2, g3);

        int.TryParse(lines[6].Split(' ')[1], out g1);
        int.TryParse(lines[6].Split(' ')[2], out g2);
        int.TryParse(lines[6].Split(' ')[3], out g3);
        guns[1] = new Gun(g1 * damage, g2, g3);

        int.TryParse(lines[7].Split(' ')[1], out g1);
        int.TryParse(lines[7].Split(' ')[2], out g2);
        int.TryParse(lines[7].Split(' ')[3], out g3);
        guns[2] = new Gun(g1 * damage, g2, g3);
...
public class PlayerMovementScript : MonoBehaviour {
	...
	void FixedUpdate () {
        ...
        //change rate of fire
		player1.g.rof--;
		if (Input.GetMouseButton (0) && player1.g.rof <= 0) {
			player1.g.shoot();
