...
public class KnightAI : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            controller.friendlyTarget = Random.Range(0, combatManager.Players.Count - 1);
    ...
    public void StartAI()
    {
        ...
        {
            controller.attacks.Add(new AttackDetails((Resources.Load("Attacks/Basic Taunt") as GameObject).GetComponent<AttackDetailsInstance>()));
            controller.attacks.Add(new AttackDetails((Resources.Load("Attacks/Defensive Formation") as GameObject).GetComponent<AttackDetailsInstance>()));
            controller.attacks.Add(new AttackDetails((Resources.Load("Attacks/Cover") as GameObject).GetComponent<AttackDetailsInstance>()));
        }
